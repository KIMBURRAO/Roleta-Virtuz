...
function prizeRuleLabel(prize: Prize): string | null {
  if (prize.forcedAtSpin) return `Cai no giro ${prize.forcedAtSpin}`
  if (prize.forcedEverySpins) return `Cai a cada ${prize.forcedEverySpins} giros`
  return null
}
